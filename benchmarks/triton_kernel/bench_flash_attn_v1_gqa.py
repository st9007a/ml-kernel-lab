...
@triton.testing.perf_report([
    triton.testing.Benchmark(
        ...
        ylabel='ms',
        plot_name='flash-attn-v1-gqa-forward-latency-seq-len',
        args={
            'batch_size': 1,
            'n_q_heads': 32,
            'n_kv_heads': 8,
    ...
    triton.testing.Benchmark(
        ...
        styles=[('blue', '-'), ('purple', '-'), ('cyan', '-'), ('green', '-'), ('red', '-')],
        ylabel='ms',
        plot_name='flash-attn-v1-gqa-causal-forward-latency-seq-len',
        args={
            'batch_size': 1,
            'n_q_heads': 32,
            'n_kv_heads': 8,
    ...
    triton.testing.Benchmark(
        ...
        ylabel='ms',
        plot_name='flash-attn-v1-gqa-forward-latency-kv-heads',
        args={
            'batch_size': 1,
            'n_q_heads': 32,
            'seq_len': 512,
    ...
    triton.testing.Benchmark(
        ...
        styles=[('blue', '-'), ('purple', '-'), ('cyan', '-'), ('green', '-')],
        ylabel='ms',
        plot_name='flash-attn-v1-gqa-forward-latency-batch-size',
        args={
            'n_q_heads': 32,
            'n_kv_heads': 8,
            'seq_len': 512,
    ...
    triton.testing.Benchmark(
        ...
        styles=[('blue', '-'), ('purple', '-'), ('cyan', '-'), ('green', '-')],
        ylabel='ms',
        plot_name='flash-attn-v1-gqa-forward-latency-head-dim',
        args={
            'batch_size': 1,
            'n_q_heads': 32,
            'n_kv_heads': 8,
...
def bench_flash_attn_v1_gqa(
    ...
    def target_fn():
        if provider == 'triton':
            return triton_kernel.flash_attention_v1_gqa_fwd(q, k, v, is_causal=is_causal)
...
if __name__ == '__main__':
    bench_flash_attn_v1_gqa.run(print_data=True, return_df=True)
